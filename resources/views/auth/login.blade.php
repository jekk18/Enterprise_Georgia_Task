        ...
        <div class="bg-white px-10 py-10 rounded-2xl shadow-2xl w-full">
            <div class="space-y-6">
                <div class="text-center">
                    <h1 class="text-3xl font-bold text-gray-800">ავტორიზაცია</h1>  
                </div>
                ...
                <div>
                    <div class="flex items-center border-2 py-3 px-4 rounded-xl mb-1 focus-within:border-blue-500 transition group">
                        ...
                        <input class="pl-3 outline-none border-none w-full text-gray-700 bg-transparent" type="email" name="email" value="{{ old('email') }}" placeholder="ელ-ფოსტა" required autofocus/>
                    </div>
                    @error('email')
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('register') }}" class="text-sm text-blue-600 hover:underline font-medium">არ გაქვთ ანგარიში? რეგისტრაცია</a>
            </div>
        </div> 
    </form>
</div>
